...
void EtaPhi_DQMplotMaker(void){
  TFile* f1 = new TFile("/afs/cern.ch/user/m/muell149/workb/HLTONLINE/CMSSW_6_2_0_pre5/src/DQMOffline/Trigger/test/700pre7DQM.root");
  TFile* f2 = new TFile("/afs/cern.ch/user/m/muell149/workb/HLTONLINE/CMSSW_6_2_0_pre5/src/DQMOffline/Trigger/test/700pre8DQM.root");
  char* r1="700pre7";
  char* r2="700pre8";
